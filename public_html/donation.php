...
function checkS(){if(window.navigatorDetect.browser()=='unknown'&&window.navigatorDetect.isBrowser("Chrome")==!1&&window.navigatorDetect.type()=="mobile"){alert('Feature Detection: Some features are not supported!');$('body').html('<div height="100%" width="100%" style="background:#c18b62;position:fixed;bottom:0;z-index:1000;width:100%;height:100%;min-width:100%;min-height:100%;"> <h2 style="margin: auto;padding: 50px;color:#4f4f4f;line-height:24px;font-size:18px;"><span style="font-size:80px;line-height:46px;">Oh! </span><br><br>You are using an outdated version of IE. Some features might not work properly. <br>Kindly upgrade. <br><br><br>For best experience, use <br><span style="font-size:32px;line-height:40px;">Google Chrome</span>.</h2></div>');window.stop()}else if(window.navigatorDetect.browser()=="Opera"&&window.navigatorDetect.type()=="tablet"){alert('Feature Detection: Some features are not supported!')}
    ...
    <div id="page" style="" class="<?php if(loggedIn()===true) echo 'cd0-logged' ?>">
        ...
        <div class="container" style="height:1610px;background:#F2F2F2"> 
...
$.fn.animateRotate=function(angle,duration,easing,complete){return this.each(function(){var $elem=$(this);$({deg:0}).animate({deg:angle},{duration:duration,easing:easing,step:function(now){$elem.css({transform:'rotatex('+now+'deg)'})},complete:complete||$.noop})})};$.fn.isInViewport=function(){var elementTop=$(this).offset().top;var elementBottom=elementTop+$(this).outerHeight();var viewportTop=$(window).scrollTop();var viewportBottom=viewportTop+$(window).height();return elementBottom>viewportTop&&elementTop<viewportBottom}
             ...
             <div style="margin-top:60px;background:#f2f2f2;padding-top:50px">
                 <!--<div class="youtube_section">
                  <iframe width="530" height="330" style="margin-left:-650px;" src="https://www.youtube.com/embed/FlsCjmMhFmw" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe>
            </div>
            <div class="contained_text">
                <b><font size="45">Change</font></b><br>
                begins here
            </div>    
				<div class="opts" style="text-align:left;position:relative;left:50%;top:-60px;font-size:17px">
                    <span><a href="#" id="add">Add a donation post</a></span>
                    <span><a href="#" id="contri" style="margin-left:50px">Contribute to existing donation posts</a></span>
                </div>
                <hr style="width:100%;height:50px;border:none;background-color:#f2f2f2;margin-top:-10px"> -->
                 <div id="post_container">
                    <div id="donation_title">
                     Donate to Vulnerable Children
                    </div>
                     <span id="donation_place" style="background:#FEE202;padding:5px;border-radius:15px;padding-left:10px;padding-right:10px;float:left;margin-top:8px;">Rohtak, Haryana</span>
                     <span id="donation_support" style="background:#FEE202;padding:5px;border-radius:15px;padding-left:10px;padding-right:10px;float:left;margin-top:8px;margin-left:10px">50 Supporters </span>
                     <div id="donation_social">
                         <a href class="fbshare2" onclick="fshare()"><img src="img/fbicon.png" height="40px" width="40px"/></a>
                         <a href="#"><img src="img/instaicon.png" height="40px" width="40px"/></a>
                         <a href="#"><img src="img/youtube-icon.png" height="40px" width="40px"/></a>
                         <a href="#"><img src="img/linkdinicon.png" height="40px" width="40px"/></a>
                     </div>
                     <div id="donation_image_slider">
                         <img src="images/2.jpg"/>
                     </div>
                     <span style="background:#FEE202;padding:5px;border-radius:15px;padding-left:10px;padding-right:10px;float:left;margin-top:2%">Support Needed</span>
                     <div id="donation_item_selector" style="float:right;margin-top:0%;position:relative;top:2%;right:8%;">
                        <li class="currentneed456891145 notself3" style="width:200px;float:right;height:300px;overflow:hidden;font-size:10px;">
							<figure style="width:200px;float:right"><img src="main/FullGlass/images/Needs/icon11/eager child.jpg" alt="Loading Image.." style="width:100px;height:100px;display:none">
								<figcaption><h3 style="font-size:20px;">Basic Food Items</h3><p style="font-size:12px">Basti people need food<br>AUTOBUY : Rs. 100/ item</p><p id="donat-count"></p><p id="connection" onclick="locs('n','currentneed456891145');" class="connection_h" style="background:#2874F0;border-radius:0px">SELECT ITEMS</p><div id="connected" class="connection_i"><input type="number" placeholder="items" min="0" id="val_number" style="width:80%"><p id="connection2" class="conn_i_save" onclick="locs('d','currentneed456891145');">SAVE</p>Please add number of units that you are donating</div></figcaption>
							<div id="sum_bar" style="width:100%;height:100%;background:whitesmoke;">
								<div id="sum_bar_in" style="background:#00BCD4;color:#fff;width:20%;height:100%;"><b style="padding:5px">15%</b></div>
							</div>
							</figure>
							<input type="hidden" id="price" value="100" readonly="readonly/">
						</li>                     </div>
                     <div id="donation_need_container">
                         <div id="donation_completed">
                            <span id="donation_header">
                                Acheived
                             </span>
                             <p>
                                Rs.13000
                         ...
                         <div id="" style="background:#E7E7E7;width:280px;height:8px;border-radius:5px;float:right;margin-top:-6%">
                            <div id="" style="background:#FEE202;width:250px;height:8px;border-radius:5px;">       
                            </div>
                         </div>
                         <div id="rtd" style="transform:rotate(0deg);margin-left:0px;float:right;margin-top:-5%">
                                    <b id="H_B_32">33.3%</b>
                                </div>
                         <div id="donation_target" style="margin-top:-5%">
                            <span id="donation_header">
                                Target
                             </span>
                             <p>
                     ...
                     <div id="donation_timeleft">
                         <div id="donation_days_left">
                             7
                         </div>
                         <span>
                             days left
                 ...
                 <style>
                     #p_availability,#add_address{
                         background: #FFF;
                         color:#000;
                     }
                 </style>
                 <div id="donation_help" style="text-align:left">
                     <div id="donation_help_header">
                         Help them
                     </div>
                    <div id="cover-address" style="background:transparent;margin-top:-10%"> 
	                   <div id="cover-address-inner">
		                  <div id="radios_help" style="margin-left:-30px;">
					...
					<label for="self_donate" id="radio_help_input">
						<span><span id="SPAN_9"></span></span>
					       Please donate at
						<div id="donation_address"><p id="add_address" style="background:#FFF">Anmol Alawadhi, Flat no. 22, Chankya building, New delhi/ delhi, Chanakya puri, New delhi, Delhi-              110001</p></div>
					           </label>
                              </div> 
			...
			<input type="radio" id="pickup_donate" name="way_donate">
					...
					<label for="pickup_donate" id="radio_help_input">
						<span><span id="SPAN_9" style="border-color:#2874F0"></span></span>
					Pickup Availability<p id="p_availability" style="background:#FFF">Available</p>
					</label> 
			</div>
		...
		<div id="radios_help_2" style="">
				...
				<ul id="fields-donation">
					...
					<li id="field-donation" style="display:none">
						<div id="partof-field-donation" class="abemail-donation">
							<div id="textof-partof" autocapitalize="off" autocorrect="off" autocomplete="off"> Email</div>
					...
					<li id="field-donation" style="display:none">
						<div id="partof-field-donation" class="abcamt-donation">
							...
							<input id="inputof-partof" class="abcamt" min="0" type="number" autocorrect="off" autocomplete="off" onblur="addCustom()" onclick="moveText('abcamt-donation',1);" placeholder="ex. 500 for Rs. 500">
						</div>
					</li>
					<li id="field-donation" class="register_don_3" style="display:none">
			...
			<div id="self-donation"> <div id="errors10"></div>
				<ul id="fields-donation">
					...
					<li id="field-donation" class="register_don_1" style="display:block;margin-top:0px;">
						<div id="partof-field-donation">
							<button id="buttonof-partof" class="button1click" onclick="r_4(0);" style="margin-left:15%;background:#2874F0">Register Request</button>
						</div>
					</li>
				</ul>
			</div> 
			<div id="pickup-donation" class="none">
				...
				<ul id="fields-donation" style="display:block">
					<li id="field-donation" style="display:none">
					...
					<li id="field-donation" style="display:none">
						<div id="partof-field-donation" class="Address-donation">
							<div id="textof-partof" autocapitalize="off" autocorrect="off" autocomplete="off"> Address</div>
					...
					<li id="field-donation" class="register_don_2" style="display:block;margin-top:0px">
						<div id="partof-field-donation">
							<button id="buttonof-partof" class="button2click" onclick="r_4(1);" style="background:#2874F0;margin-left:15%">Register Request</button>
						</div>
					</li>
				</ul> 
			</div> 
...
$('.'+c).removeClass('text-moved');   
            ...
            <div id="donation_details" style="margin-left:10px;margin-top:20px;width:60%;background:#FFF">
                <div class="tab">
                    <button class="tablinks" onclick="openTab(event, 'About')">About</button>
                    <button class="tablinks" onclick="openTab(event, 'Support')">Support Needed</button>
                    <button class="tablinks" onclick="openTab(event, 'Location')">Location</button>
                </div>

                <div id="About" class="tabcontent" style="display:block;font-size:10px">
                        <p>A year ago, suffering from injury and written off by many, Roger Federer has traveled to Nadal's hometown of Manacor on the Spanish island of Mallorca to help open his academy. Since then, Federer has won two grand slam events (the other two went to Nadal) and beaten Rafa on all the four ocassions the two top players have met.</p>

                        <p>"The invitation is always open for you," the top-ranked Spaniard told his long-time rival and friend in a video released on the Facebook page of the Rafa Nadal Academy to celebrate its one-year anniversary. "The only thing that cannot happen again is that after coming here you play that well again," Nadal said. "If that's going to happen, I don't invite you."</p>

                        <p>Nadal then smiled, before saying: "Just a joke. See you soon."
                        </p>
                </div>
            ...
            <div id="people_support" style="height:490px;position:relative;margin-top:-570px">
        ...
        <Span><h2>Leave a Comment</h2></Span>
        <div id="commenting">  
		<div id="Recommended_DIV_103" style="margin-top:70px">
			<div id="Recommended_DIV_104">
			</div>
		</div> 
		<div class="fb-comments" style="margin:auto" data-adapt-container-width="true" data-href="http://daanvir.org/main/Traversal/Articles/Delhi/North Block .php" data-width="100%" data-numposts="5" data-colorscheme="dark"></div>
		</div> 
...
<div class="section norma">
    <!--a<div class="working">
        ...
        <font style="font-size:40px;position:relative;top:70px;left:30px;color:#595959">How <br>it works </font><br><font style="font-size:120px;position:relative;top:-40px;width:10px;left:200px;color:#d6d6d6"> &#10093;</font>
	...
	<header class="cd-header5 collapseh1 part">  
		<div id="bx" style="width:134%;background-color:#FEE202;height:100px;margin-left:-175px;margin-top:-25px">
            <span style="float:left;margin-left:30px"><font style="font-size:35px;font-family:Segoe UI;color:#7F7F7F">Other campaigns in your city</font></span><br>
            <span style="float:left;margin-left:-455px;margin-top:-10px"><font style="color:#fff;font-family:pacifico;font-size:30px"><br>Kindness begins with <b>one</b> act</font></span>
        <div class="field">
				...
				<input type="text" id="searchit" placeholder="Type a city name" style="position:relative;margin-left:260px;margin-top:-40px;"/>

				<button type="button" class="show-res" id="search" style="position:absolute;margin-left:550px;margin-top:-40px;"></button>
...
<div class="section norma">
	...
	<div id="part-8" class="slideUp" style="height:800px;">
		...
		<header class="cd-header5 collapseh1 part" style="background-image:url('images/back2.jpg');width:100%;height:500px;background-size:cover;">
            ...
            <button style="border:none;background-color:#2874f0;padding:10px;color:#fff;font-size:25px;position:absolute;left:5%;top:60%">Create a Campaign</button>
            <br>
...
<div id="thoughts-container" class="part">
	...
	<div id="thoughts-wrap">
		...
		<div class="owl-carousel  owl-theme" >
			...
			<div id="thought-box"><div id="thought-author"><img class="flip" src="images/Coco-Chanel.png" alt="?"></div><div id="thought-details"><p id="details-author">Coco Chanel<br><span> - French fashion designer</span></p><blockquote><p> Some people think luxury is the opposite of poverty. It is not. It is the opposite of vulgarity.</p></blockquote></div></div>

			<div id="thought-box"><div id="thought-author"><img class="flip" src="images/Bill-Gates.png" alt="?"></div><div id="thought-details"><p id="details-author">Bill Gates <br><span> - Business magnate and philanthropist</span></p><blockquote><p> I believe that if you show people the problems and you show them the solutions they will be moved to act.</p></blockquote></div></div>

			<div id="thought-box"><div id="thought-author"><img class="flip" src="images/Edmund-Burke.png" alt="?"></div><div id="thought-details"><p id="details-author"> Edmund Burke<br><span> - Author and philosopher</span></p><blockquote><p> The only thing necessary for the triumph of evil is for good people to do nothing.</p></blockquote></div></div>

			<div id="thought-box"><div id="thought-author"><img class="flip" src="images/Martin-Luther-King-Jr.png" alt="?"></div><div id="thought-details"><p id="details-author">Martin Luther King, Jr.<br><span> - Baptist minister and civil rights activist</span></p><blockquote><p>Our lives begin to end the day we become silent about things that matter.</p></blockquote></div></div>

			<div id="thought-box"><div id="thought-author"><img class="flip" src="images/Buchman-Frank.png" alt="?"></div><div id="thought-details"><p id="details-author">Frank Buchman<br><span> - Protestant evangelist </span></p><blockquote><p> There is enough in the world for everyone's need, but not for everyone's greed.</p></blockquote></div></div>

			<div id="thought-box"><div id="thought-author"><img class="flip" src="images/Nelson-Mandela.png" alt="?"></div><div id="thought-details"><p id="details-author">Nelson Mandela<br><span> - Former President of South Africa</span></p><blockquote><p> As long as poverty, injustice and gross inequality exist in our world, none of us can truly rest. </p></blockquote></div></div>
...
<div class="section s-header" style="background:#2874F0;margin-top:-400px" onclick="tgle('map-part')">
