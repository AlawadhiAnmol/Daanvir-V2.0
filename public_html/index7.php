...
<body>  
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5b1801f7be8baa28"></script>
<header class="cd-header nav-down">
  ...
  <!--<a  id="heart-main" style="float:left;padding-left:40px;">Made with <strong id="heart"></strong> in India</a> -->    <span id="asdd_post"><b></b><a href="javascript:" onclick="open_page(30);">Add a Donation Post</a></span> |  <!--<b id="feeding_india"><i></i></b><a href="http://www.feedingindia.org">Feeding India</a> | --><a href="#part-5">FAQs</a> 
  		...
  		<div><input type="text" placeholder="City" style="float: left;padding: 10px 100px 10px 25px;margin-top: "></div>
...
$.fn.animateRotate=function(angle,duration,easing,complete){return this.each(function(){var $elem=$(this);$({deg:0}).animate({deg:angle},{duration:duration,easing:easing,step:function(now){$elem.css({transform:'rotatex('+now+'deg)'})},complete:complete||$.noop})})};$.fn.isInViewport=function(){var elementTop=$(this).offset().top;var elementBottom=elementTop+$(this).outerHeight();var viewportTop=$(window).scrollTop();var viewportBottom=viewportTop+$(window).height();return elementBottom>viewportTop&&elementTop<viewportBottom}
			 ...
			 <header class="cd-header2 part <?php if(loggedIn()===true) echo 'cd2-logged' ?>">
                ...
                <!--<h1>Daanvir <span>India</span></h1>

                <p style="display:none" id="showp"><i>Every life</i> is vulnerable .. </p>-->
                 
                 
				<!--<div id="typed-strings">

                <p><i>Every life^800</i> is vulnerable</p>

                <p>They are our ^200<i>true forms</i></p>

                <p>Develop <i>invisible ^900relations</i></p>

                <p>Help and share <i>the bold smiles</i></p>

                <p>An initiative to <i>fill the depressions of economy</i></p>

                <p>Experimenting the intervention of humans <i>in economy</i></p>

				</div>

                <h2><span id="dtag"></span></h2>
				...
				<button type="button" class="show-res" id="search" >Search</button>
  ...
  $(function(){
	...
	$('#showp').css({
		...
		color:'#fff'
			 ...
			 <!--<header class="cd-header3">

                <h1>Join our community to <span>lead a change</span></h1><input class="copyemail" type="text" placeholder="mymail@mail.com"/><button id="joinnow" onclick="bring(2);">Join Now!</button>
...
<div class="section norma">
	...
	<header class="cd-header5 collapseh1 part">  
        ...
        <h1 style="color:rgba(0, 0, 0, 0.701961)"><span>Donation Posts</span></h1>   

		</div>

		<div id="bx">

        <p class="dontn_p">Donation requests in India.<br> Use the search bar to filter according to the city of your choice. </p>
...
<div class="section norma">
    ...
    vertical-align: -webkit-baseline-middle;"><span>About Daanvir</span></h1> 

		</div>

		<div id="bx">

		<p class="pad_30">Daanvir.org is a movement <span>to mobilize people to help the needy directly</span>.</p>

		</div>

	</header> <br><br>

	<p class="help_p">If you see someone around you who needs help, put up a post on Daanvir and ask others around to contribute to them. You can ask others to donate directly to the needy or you can collect their contributions and give everything to the needy together.
...
<div class="section">
	...
	<div class="sec_anim overload_anim">

	<header class="cd-header5">

        <h1><span>Everyone can take <b style="text-decoration:underline">action</b></span></h1> 

	</header>

	</div> 

	<div id="part-15" class="part action"></div>
...
<div id="part-5" class="mob_5" style="background-color:#ffcf79;padding-bottom:0;"><header class="cd-header5 part three_steps"> 

		<p style="text-align:center">3 Simple steps<br> to help people <span style="text-decoration:underline;">easily</span></p>

	</header>

<div id="process-line" class="slideUp">
...
<li id="process"><img src="images/part-1.png" id="rot1"/> <p><b>1</b><span>Choose a community you want to help</span></p></li>



<li id="process"><img src="images/part-2.png" id="rot2"/> <p><b>2</b><span>Select how you can help</span></p></li>



<li id="process"><img src="images/part-3.png" id="rot3"/> <p><b>3</b><span>Confirm your donation details</span></p></li>
...
<li id="process" class="sp_process"><img src="images/part-4.png"/> <p>Share this with others and <br>encourage people to help people in need!
...
<div class="section">
	...
	<!-- <div id="video_box" style="background-image:url(videos/video.png)"> -->

	<div id="video_box">

	<video id="fsVideo" loop 
  ...
  onmouseleave="pause()">
		...
		<div id="vid_button_box">

		<a href="javascript:void(0)" title="Feel the change with Daanvir" id="play_button_link"><img src="images/video-search.png" alt="Play Image" id="play_button_icon" /></a>

		<h3 id="play_button_title">

			Watch How Daanvirs are bringing a new change
	...
	<script type="text/javascript">var video=document.getElementById('fsVideo');$('#play_button_icon, #fsVideo').on('click',function(){video.load();$('#vid_button_box').css('display','none')})
...
initMap();function initMap(){var styledMapType=new google.maps.StyledMapType([{elementType:'geometry',stylers:[{color:'#ebe3cd'}]},{elementType:'labels.text.fill',stylers:[{color:'#523735'}]},{elementType:'labels.text.stroke',stylers:[{color:'#f5f1e6'}]},{featureType:'administrative',elementType:'geometry.stroke',stylers:[{color:'#c9b2a6'}]},{featureType:'administrative.land_parcel',elementType:'geometry.stroke',stylers:[{color:'#dcd2be'}]},{featureType:'administrative.land_parcel',elementType:'labels.text.fill',stylers:[{color:'#ae9e90'}]},{featureType:'landscape.natural',elementType:'geometry',stylers:[{color:'#dfd2ae'}]},{featureType:'poi',elementType:'geometry',stylers:[{color:'#dfd2ae'}]},{featureType:'poi',elementType:'labels.text.fill',stylers:[{color:'#93817c'}]},{featureType:'poi.park',elementType:'geometry.fill',stylers:[{color:'#a5b076'}]},{featureType:'poi.park',elementType:'labels.text.fill',stylers:[{color:'#447530'}]},{featureType:'road',elementType:'geometry',stylers:[{color:'#f5f1e6'}]},{featureType:'road.arterial',elementType:'geometry',stylers:[{color:'#fdfcf8'}]},{featureType:'road.highway',elementType:'geometry',stylers:[{color:'#f8c967'}]},{featureType:'road.highway',elementType:'geometry.stroke',stylers:[{color:'#e9bc62'}]},{featureType:'road.highway.controlled_access',elementType:'geometry',stylers:[{color:'#e98d58'}]},{featureType:'road.highway.controlled_access',elementType:'geometry.stroke',stylers:[{color:'#db8555'}]},{featureType:'road.local',elementType:'labels.text.fill',stylers:[{color:'#806b63'}]},{featureType:'transit.line',elementType:'geometry',stylers:[{color:'#dfd2ae'}]},{featureType:'transit.line',elementType:'labels.text.fill',stylers:[{color:'#8f7d77'}]},{featureType:'transit.line',elementType:'labels.text.stroke',stylers:[{color:'#ebe3cd'}]},{featureType:'transit.station',elementType:'geometry',stylers:[{color:'#dfd2ae'}]},{featureType:'water',elementType:'geometry.fill',stylers:[{color:'#b9d3c2'}]},{featureType:'water',elementType:'labels.text.fill',stylers:[{color:'#92998d'}]}],{name:'Daanvir Office'});var map=new google.maps.Map(document.getElementById('map'),{center:{lat:34.125051,lng:74.837516},zoom:16,mapTypeControlOptions:{mapTypeIds:['roadmap','satellite','hybrid','terrain','styled_map']}});map.mapTypes.set('styled_map',styledMapType);map.setMapTypeId('styled_map')}
	...
	<span><h4>&copy; 2017 - All Rights Reserved | <a  id="heart-main" >Made with <strong id="heart"></strong> in India</a></h4></span>
