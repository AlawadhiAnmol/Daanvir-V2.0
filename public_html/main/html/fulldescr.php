...
> Uncheck: Block third-party cookies and site data. </div>
    ...
    border-color: #4267b2;\">Share Now!</a>
		...
		<div style=\"visibility:hidden;opacity:0;height:2px;overflow:hidden\" class=\"fb-share-button\" data-href=\"http://daanvir.org/main/Traversal/Articles/".$stn."/".$locn.".php\" data-layout=\"button_count\" data-size=\"large\" data-mobile-iframe=\"true\"><a class=\"fb-xfbml-parse-ignore\" target=\"_blank\" id=\"fbshare\" href=\"https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fdaanvir.org%2Fmain%2FTraversal%2FArticles%2F".$stn."%2F".$locn.".php;src=sdkpreparse\">Share</a></div>
...
function Load(){
	var g='i='+".$locid."+'&id='+3; $.ajax({type:\"POST\",url:\"../../../html/fulldescr.php\",data:g,dataType:\"json\",cache:false,success:function(n){ if(n.a!=null){
