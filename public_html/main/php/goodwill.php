...
<div id="acc-wrap" class="bring"> 
		<div id="acc-user-info">
			<div id="info-box">
			<div id="res-box" class="now">
			<h4>1</h4>
			<h3>BRING SMILES</h3>
			
			</div>
			<div id="res-box" class="forward">
			<h4>2</h4>
			<h3>LOCALITY</h3> 
	...
	<div id="acc-wrap-in">  
		...
		<button id="bbback" onclick="moveg('locality')">GET STARTED!</button>
		<button id="bback" style="display:none; border:0; cursor:default"></button>
   ...
   <li><input type="radio" id="option000" name="selector0" disabled="disabled">
    ...
    <input class="check-custom2" id="locality2" name="locs" type="checkbox" disabled="disabled"><label for="locality2">No Circle Choosen</label>
		  ...
		  <div id="head5in-side2">
			<div id="headin-head">
				<h2>Select Current Needs<br><hr></h2>
			</div> 
...
<h3>Email : </h3>			
    ...
    <input class="phonefiller" id="innum" style="width:98%;" type="text" autocomplete="off" placeholder="e.g 9018943671 " value="<?php echo $userData['phone'];?>"> 
		  ...
		  <div id="head5in-side2">
			...
			<div id="custbody2" class="bottom-button cust">
<h3>State: </h3>			
    <input class="statefiller" id="initem" type="text" autocomplete="off" placeholder="e.g shawls, shoes" value="<?php echo $userData['state'];?>"> 
<h3>City : </h3>			
    <input class="cityfiller" id="indet" type="text" autocomplete="off"placeholder="e.g J & K" value="<?php echo $userData['city'];?>"> 
			<h3>Address : </h3>			
    <input class="addressfiller" id="innum" style="" type="text" autocomplete="off" placeholder="e.g House No. 1, Mohalla Nirvan " value="<?php echo $userData['address'];?>"> 
			<h3>Near : </h3>			
    <input class="nearfiller" id="innum" style="" type="text" autocomplete="off" placeholder="e.g Idea Office"> 
			<h3>Zip : </h3>			
    <input class="zipfiller" id="innum" style="" type="text" autocomplete="off" placeholder="e.g 189756 " value=""> <script> $(function(){$("#datepicker").datepicker({minDate:-0,maxDate:"+1M +10D",showAnim:"blind",defaultDate:"+1d",changeMonth:true,numberOfMonths:1,onClose:function(a){$("#to").datepicker("option","minDate",a)}});$("#to").datepicker({minDate:-0,maxDate:"+1M +10D",showAnim:"blind",defaultDate:"+2d",changeMonth:true,numberOfMonths:1,onClose:function(a){$("#datepicker").datepicker("option","maxDate",a)}})});
...
<div id="acc-wrap" class="review locality"> 
	...
	<div id="acc-wrap-in">  
		...
		<div id="head5in-side">
			...
			<div id="custbody3"  style="margin-right:25px;" class="bottom-button cust">
...
Please have patience until we reach you. 
		...
		<div id="head5in-mid">  
		  ...
		  <div id="head5in-side2">
			...
			<div id="custbody3" class="bottom-button cust"> 
			<div id="conbody"> 
			<h3 style="margin-left:30px;margin-bottom:20px;">No. But, you will be charged INR 50.00 if you want the items to be packed as a bigger gift. </h3>
			
    <input class="check-custom2" id="campdon" type="checkbox" name="campaignhelp"><label for="campdon">Campaign This.</label> 
    <input class="check-custom2" id="gifted" type="checkbox" name="gifthelp"><label for="gifted">Pack as big gift.</label>
...
<div id="acc-wrap" class="subbed"> 
	...
	<div id="acc-wrap-in">
	<h3>If you opted for 'Campaign This', we have saved a template for you that you can share with your friends. We will contact you soon for further details on your request. Have a happy and nice day.</h3>
	</div>
</div>  
<script language="javascript"> function move_fill(p){if(p=="c"){var o=getCheckedBoxes("locneeds");if(o==null){var a="null"}else{var a=o.join(",")}var l="checks="+a+"&meter="+p}else{if(p=="s"){var o=getCheckedBoxes("helped");if(o==null){var a="null"}else{var a=o.join(",")}var d=$(".statefiller").val();var q=$(".cityfiller").val();var c=$(".addressfiller").val();var t=$(".nearfiller").val();var u=$(".zipfiller").val();var v=$(".pickfrom").val();var g=$(".pickbefore").val();var e=$(".phonefiller").val();var k=$(".emailfiller").val();var r=$(".fullnamefiller").val();var j=$(".sharereasons").val();var h=getCheckedBoxes("campaignhelp");if(h==null){var b="null"}else{var b=1}var s=getCheckedBoxes("gifthelp");if(s==null){var n="null"}else{var n=1}var f=getCheckedBoxes("tandc_");if(f==null){var i="null"}else{var i=1}if(i==1){var l="checks="+a+"&meter="+p+"&state="+d+"&city="+q+"&address="+c+"&near="+t+"&zip="+u+"&pickfrom="+v+"&pickbefore="+g+"&phone="+e+"&email="+k+"&fullname="+r+"&textarea="+j+"&camp="+b+"&gift="+n}else{var l="checks="+a+"&meter="+p}}}$.ajax({type:"POST",url:"php/collectneeds.php",data:l,cache:false,success:function(m){if(p=="c"){if(m=="f"){}else{document.getElementsByClassName("loadtoconfirmneeds")[0].innerHTML=m;moveg("fill")}}else{if(p=="s"&&i==1){if(m=="s"){moveg("subbed")}}}}});return};
		</script>
