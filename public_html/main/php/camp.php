...
<div id="acc-wrap" class="started"> 
	...
	<div id="acc-wrap-in">  
		<div id="head"><h2>Let others know about this calamity</h2></div>
		<div id="head2"><h3>This is Simple! You Add contacts, Involve people, Type in a Real message and Send <br>Lets Get Started</h3></div>	
		<div id="head3"><h2> </h2></div> 
		<div id="head4"><h2>Sometimes, we need no good reason to start.</h2></div>
		<div id="head4">
		<!--
...
<div id="moveleft">	
	   ...
	   <div id="head5">
		<div id="head5in-side" class="rotl">
			...
			<div id="conbody" class="sloadspread">
		</div>
		</div>
		 <div id="head5in-side" class="rotr">
			<div id="headin-head">
			...
			<div id="conbody" class="eloadspread">
		</div>
	  </div>
		<div id="head5in-mid"> 
			<div id="headin-head">
				...
				<div id="conbody" class="floadspread">
			</div>
		</div> 
	   </div>
	   </div><script language="javascript"> $(".loadaudience").click(function(){move("involved");$(".sloadspread").load("php/loads.php .sfilterspread");$(".eloadspread").load("php/loads.php .efilterspread");$(".floadspread").load("php/loads.php .ffilterspread");$(".contact_edit_new").show();$(".contactView").addClass("contact_edit")});function selcntrl(f,a){if(a==="sms"){a="s";var e="notsels";var d="sels"}else{if(a==="email"){a="e";var e="notsele";var d="sele"}else{a="f";var e="notself";var d="self"}}var b=".SelCntrl"+a+f;if($(b).is("."+d)){$(b).removeClass(d);$(b).addClass(e)}else{$(b).removeClass(e);$(b).addClass(d)}return};
...
<div id="acc-wrap" class="dubbed"> 
	...
	<div id="acc-wrap-in">
	<h3>Keep sharing and let your friends and followers know about how you are working against evils of the society. Let them build happiness for others and spread this work as far as possible simply because this is good.</h3>
	</div>
</div> 
