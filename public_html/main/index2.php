...
<header class="cd-header nav-down" style="box-shadow:1px 1px 6px rgba(0,0,0,0.5),inset 0 0 3px rgba(255,255,255,0.6);
    -moz-box-shadow:1px 1px 6px rgba(0,0,0,0.5),inset 0 0 3px rgba(255,255,255,0.6);
    -webkit-box-shadow:1px 1px 6px rgba(0,0,0,0.5),inset 0 0 3px rgba(255,255,255,0.6);
    ">
			<div id="above-nav">
			<i style="    float: left;
...
$.fn.animateRotate=function(angle,duration,easing,complete){return this.each(function(){var $elem=$(this);$({deg:0}).animate({deg:angle},{duration:duration,easing:easing,step:function(now){$elem.css({transform:'rotatex('+now+'deg)'})},complete:complete||$.noop})})};$.fn.isInViewport=function(){var elementTop=$(this).offset().top;var elementBottom=elementTop+$(this).outerHeight();var viewportTop=$(window).scrollTop();var viewportBottom=viewportTop+$(window).height();return elementBottom>viewportTop&&elementTop<viewportBottom}
            ...
            <div style="margin-top:58px;background:#fff;padding-top:50px;height:430px;">
            <div class="slider w3-animate-right" style="margin-top:30px;">
            <div class="youtube_section">
                  
                  <iframe width="43%" height="330" style="margin-left:-650px;" src="https://www.youtube.com/embed/iA4H2N97zCg" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe> 
            </div>
            <div class="contained_text">
				...
				<div class="opts" style="text-align:left;position:relative;left:50%;top:-60px;font-size:17px">
                    ...
                    <span><a href="#part-2" id="contri" style="margin-left:50px">Contribute to existing donation posts</a></span>
                </div>
                <hr style="width:100%;height:55px;border:none;background-color:#f2f2f2;margin-top:20px">
            </div>
            <div class="slider w3-animate-right" style="background:url('back3.jpg');background-size:cover;height:380px;margin-top:30px;">
            ...
            <div class="contained_text" style="color:#FFF;text-align:left;height:300px;width:600px;margin-right:75px">
                ...
                <a href="javascript" onclick="open_page(30);"><button id="c_campaign" style="border:none;background-color:#2874f0;padding:10px;color:#fff;font-size:25px;position:absolute;right:35%;top:75%">Create a Trend</button></a>
            ...
            <div class="contained_text">
                <b><font size="45">CSamplee</font></b><br>
                begins here
            </div>    
				<div class="opts" style="text-align:left;position:relative;left:50%;top:-60px;font-size:17px">
                    <span><a href="javascript" onclick="open_page(30);" id="add">Add a donation post</a></span>
...
<div class="section norma">
	...
	<header class="cd-header5 collapseh1 part">  
		<div id="bx" style="width:134%;background-color:#FEE202;height:100px;margin-left:-175px;margin-top:-25px">
            <span style="float:left;margin-left:30px"><font style="font-size:35px;font-family:Segoe UI;color:#7F7F7F">Help people in your city</font></span><br>
...
var na=n.split(',');if(na.length==2){var w=window.open(na[1]+"",'Daanvir');w.focus()}}})}else{open_page(35);/*open_page(29);$(function(){wait()});function wait(){if(typeof(promote_ls)==='undefined'){setTimeout(wait,100);return}
