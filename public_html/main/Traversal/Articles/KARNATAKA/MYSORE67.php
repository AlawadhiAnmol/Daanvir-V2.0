<!DOCTYPE html>
<html> 
<head><title>Daanvir - The brave steps that lead the nation</title><meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1,user-scalable=no"><link rel="stylesheet" href="../../../normalize.css"><script src='../../../js/jquery.min.js'></script><link rel="shortcut icon" href="../../../images/favicon.png" type="image/x-icon"><link rel="stylesheet" href="../../../css/orton.css"><meta property="og:url"           content="http://daanvir.org/main/Traversal/Articles/KARNATAKA/MYSORE67.php" />
	<meta property="og:type"          content="website" />
	<meta property="og:title"         content="Daanvir | Little angels of my dream  Adventure" />
	<meta property="og:description"   content="Emperor's Domination
Action" />
	<meta property="og:image"         content="http://daanvir.org/../../../Traversal/images/26/FB_IMG_1523690280137.jpg" />
</head>
<body>
<div id="fb-root"></div>
<script>
...
<gcse:search></gcse:search>
		...
		<div id="hitlist_image_cover">
			  <img src="../../../Traversal/images/26/FB_IMG_1523690280137.jpg" alt="Loading Image.." id="hitlist_image" class="image1"/> 
		</div>
		<header id="hitlist_header">
			<div id="hitlist_id">
				 <a href="" id="hitlist_id_a">KARNATAKA - MYSURU - MYSORE</a>
			</div> 
			<div id="hitlist_id">
				 <a href="" id="hitlist_id_a" class="hit_location"> Adventure</a>
			</div> 
...
Action
    ...
    border-color: #4267b2;"> 
		...
		<div class="fb-comments" style="margin:auto" data-adapt-container-width="true" data-href="http://daanvir.org/main/Traversal/Articles/KARNATAKA/MYSORE67.php" data-width="100%" data-numposts="5" data-colorscheme="dark"></div>
		</div> 
	</div>
</div>
...
> Uncheck: Block third-party cookies and site data. </div>
	...
	<article id="hitlist_side"> 
		...
		<li id="H_LI_19">Emperor's Domination
Action- (0% filled)
			</li>
		</ul>
    ...
    border-color: #4267b2;">Share Now!</a>
		...
		<div style="visibility:hidden;opacity:0;height:2px;overflow:hidden" class="fb-share-button" data-href="http://daanvir.org/main/Traversal/Articles/KARNATAKA/MYSORE67.php" data-layout="button_count" data-size="large" data-mobile-iframe="true"><a class="fb-xfbml-parse-ignore" target="_blank" id="fbshare" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fdaanvir.org%2Fmain%2FTraversal%2FArticles%2FKARNATAKA%2FMYSORE67.php;src=sdkpreparse">Share</a></div>
...
function Load(){ 
	var g='i='+67+'&id='+2; $.ajax({type:"POST",url:"../../../points/trend.php",data:g,dataType:"json",cache:false,success:function(n){ 
	if(n.a!=null){
...
function fShare() { 
var obj = {method: "feed", link: "http://www.daanvir.org/Traversal/Articles/KARNATAKA/MYSORE67.php", picture: "http://daanvir.org/main/Traversal/images/26/FB_IMG_1523690280137.jpg",name: "Daanvir - Little angels of my dream",description: "Emperor's Domination
Action.  Fantasy"};
