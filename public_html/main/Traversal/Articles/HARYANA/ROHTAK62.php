<!DOCTYPE html>
<html> 
<head><title>Daanvir - The brave steps that lead the nation</title><meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1,user-scalable=no"><link rel="stylesheet" href="../../../normalize.css"><script src='../../../js/jquery.min.js'></script><link rel="shortcut icon" href="../../../images/favicon.png" type="image/x-icon"><link rel="stylesheet" href="../../../css/orton.css"><meta property="og:url"           content="http://daanvir.org/main/Traversal/Articles/HARYANA/ROHTAK62.php" />
	<meta property="og:type"          content="website" />
	<meta property="og:title"         content="Daanvir | CLothes for Clothless pappu sweets" />
	<meta property="og:description"   content="WE are local people of rohtak trying to help these people." />
	<meta property="og:image"         content="http://daanvir.org/../../../Traversal/images/6/clothless.jpg" />
</head>
<body>
<div id="fb-root"></div>
<script>
...
<gcse:search></gcse:search>
		...
		<div id="hitlist_image_cover">
			  <img src="../../../Traversal/images/6/clothless.jpg" alt="Loading Image.." id="hitlist_image" class="image1"/> 
		</div>
		<header id="hitlist_header">
			<div id="hitlist_id">
				 <a href="" id="hitlist_id_a">HARYANA - ROHTAK - ROHTAK</a>
			</div> 
			<div id="hitlist_id">
				 <a href="" id="hitlist_id_a" class="hit_location">pappu sweets</a>
			</div> 
    ...
    border-color: #4267b2;" id="hitlist_id">
			...
			<h2 id="H2_10" class="hit_tag">
				CLothes for Clothless
			</h2>
		</header>
		<div id="hitlist_expand1">
			<p id="hitlist_expand_p" class="hit_head">
				WE are local people of rohtak trying to help these people.
			</p>
		</div>
		...
		<div id="hitlist_expand1">
			<p id="hitlist_expand_p" class="ext-des">
				local people trying to get help for these people
			</p>
		</div>
		<div id="hitlist_image_cover">
			  <img  src="../../../Traversal/images/6/eager child.jpg" alt="Loading Image.." id="hitlist_image"  class="image2"/> 
		</div> 
		<div id="hitlist_expand1">
			<div id="hitlist_expand_p">
				All you have to do is fill in a form and within the next 48 hours and you could just make a young girl&rsquo;s life a little better. From providing education
			</div>
			<div id="hitlist_expand_p">
    ...
    border-color: #4267b2;"> 
		...
		<div class="fb-comments" style="margin:auto" data-adapt-container-width="true" data-href="http://daanvir.org/main/Traversal/Articles/HARYANA/ROHTAK62.php" data-width="100%" data-numposts="5" data-colorscheme="dark"></div>
		</div> 
	</div>
</div>
...
> Uncheck: Block third-party cookies and site data. </div>
	...
	<article id="hitlist_side"> 
		...
		<li id="H_LI_19">Clothes- (0% filled)
			</li>
		</ul>
    ...
    border-color: #4267b2;">Share Now!</a>
		...
		<div style="visibility:hidden;opacity:0;height:2px;overflow:hidden" class="fb-share-button" data-href="http://daanvir.org/main/Traversal/Articles/HARYANA/ROHTAK62.php" data-layout="button_count" data-size="large" data-mobile-iframe="true"><a class="fb-xfbml-parse-ignore" target="_blank" id="fbshare" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fdaanvir.org%2Fmain%2FTraversal%2FArticles%2FHARYANA%2FROHTAK62.php;src=sdkpreparse">Share</a></div>
...
function Load(){ 
	var g='i='+62+'&id='+2; $.ajax({type:"POST",url:"../../../points/trend.php",data:g,dataType:"json",cache:false,success:function(n){ 
	if(n.a!=null){
...
function fShare() { 
var obj = {method: "feed", link: "http://www.daanvir.org/Traversal/Articles/HARYANA/ROHTAK62.php", picture: "http://daanvir.org/main/Traversal/images/6/clothless.jpg",name: "Daanvir - CLothes for Clothless",description: "WE are local people of rohtak trying to help these people.. local people trying to get help for these people"};
