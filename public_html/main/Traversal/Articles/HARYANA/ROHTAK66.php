<!DOCTYPE html>
<html> 
<head><title>Daanvir - The brave steps that lead the nation</title><meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1,user-scalable=no"><link rel="stylesheet" href="../../../normalize.css"><script src='../../../js/jquery.min.js'></script><link rel="shortcut icon" href="../../../images/favicon.png" type="image/x-icon"><link rel="stylesheet" href="../../../css/orton.css"><meta property="og:url"           content="http://daanvir.org/main/Traversal/Articles/HARYANA/ROHTAK66.php" />
	<meta property="og:type"          content="website" />
	<meta property="og:title"         content="Daanvir | Need Clothes for slum chil  where these slums are located" />
	<meta property="og:description"   content="The parts of the cities" />
	<meta property="og:image"         content="http://daanvir.org/../../../Traversal/images/62/IMG-20170618-WA0024.jpg" />
</head>
<body>
<div id="fb-root"></div>
<script>
...
<gcse:search></gcse:search>
		...
		<div id="hitlist_image_cover">
			  <img src="../../../Traversal/images/62/IMG-20170618-WA0024.jpg" alt="Loading Image.." id="hitlist_image" class="image1"/> 
		</div>
		<header id="hitlist_header">
			...
			<div id="hitlist_id">
				 <a href="" id="hitlist_id_a" class="hit_location"> where these slums are located</a>
			</div> 
    ...
    border-color: #4267b2;" id="hitlist_id">
		...
		<div id="hitlist_image_cover">
			  <img  src="../../../Traversal/images/62/IMG-20170618-WA0010.jpg" alt="Loading Image.." id="hitlist_image"  class="image2"/> 
		</div> 
		<div id="hitlist_expand1">
			<div id="hitlist_expand_p">
				 as they are over populated. Please help them because they need you!
			</div>
			<div id="hitlist_expand_p">
				- Started By Chirag Nijhawan
			</div>
		</div>
		<header id="hitlist_header">
    ...
    border-color: #4267b2;"> 
		...
		<div class="fb-comments" style="margin:auto" data-adapt-container-width="true" data-href="http://daanvir.org/main/Traversal/Articles/HARYANA/ROHTAK66.php" data-width="100%" data-numposts="5" data-colorscheme="dark"></div>
		</div> 
	</div>
</div>
...
> Uncheck: Block third-party cookies and site data. </div>
	...
	<article id="hitlist_side"> 
		...
		<li id="H_LI_19">The locality has plenty of problems but the basic rging ther require are clothes- (0% filled)
			</li>
		</ul>
    ...
    border-color: #4267b2;">Share Now!</a>
		...
		<div style="visibility:hidden;opacity:0;height:2px;overflow:hidden" class="fb-share-button" data-href="http://daanvir.org/main/Traversal/Articles/HARYANA/ROHTAK66.php" data-layout="button_count" data-size="large" data-mobile-iframe="true"><a class="fb-xfbml-parse-ignore" target="_blank" id="fbshare" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fdaanvir.org%2Fmain%2FTraversal%2FArticles%2FHARYANA%2FROHTAK66.php;src=sdkpreparse">Share</a></div>
...
function Load(){ 
	var g='i='+66+'&id='+2; $.ajax({type:"POST",url:"../../../points/trend.php",data:g,dataType:"json",cache:false,success:function(n){ 
	if(n.a!=null){
...
function fShare() { 
var obj = {method: "feed", link: "http://www.daanvir.org/Traversal/Articles/HARYANA/ROHTAK66.php", picture: "http://daanvir.org/main/Traversal/images/62/IMG-20170618-WA0024.jpg",name: "Daanvir - Need Clothes for slum chil",description: "The parts of the cities.  are quite congested"};
