...
D
Dj" />
	<meta property="og:image"         content="http://daanvir.org/../../../Traversal/images/26/Hangouts_Penguins_006.png" />
</head>
<body>
<div id="fb-root"></div>
<script>
...
<gcse:search></gcse:search>
		...
		<div id="hitlist_image_cover">
			  <img src="../../../Traversal/images/26/Hangouts_Penguins_006.png" alt="Loading Image.." id="hitlist_image" class="image1"/> 
		</div>
    ...
    border-color: #4267b2;" id="hitlist_id">
		...
		<div id="hitlist_expand1">
			<p id="hitlist_expand_p" class="hit_head">
				Ajhsjsksod preety jo teri mujhdr jufi wo kisi or sr nhi jodna
Nhi jodn a
Jodna jond
A jznsobagsjabof
Dmf
...
Dj
    ...
    border-color: #4267b2;"> 
		...
		<div class="fb-comments" style="margin:auto" data-adapt-container-width="true" data-href="http://daanvir.org/main/Traversal/Articles/HARYANA/ROHTAK71.php" data-width="100%" data-numposts="5" data-colorscheme="dark"></div>
		</div> 
	</div>
</div>
...
> Uncheck: Block third-party cookies and site data. </div>
    ...
    border-color: #4267b2;">Share Now!</a>
		...
		<div style="visibility:hidden;opacity:0;height:2px;overflow:hidden" class="fb-share-button" data-href="http://daanvir.org/main/Traversal/Articles/HARYANA/ROHTAK71.php" data-layout="button_count" data-size="large" data-mobile-iframe="true"><a class="fb-xfbml-parse-ignore" target="_blank" id="fbshare" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fdaanvir.org%2Fmain%2FTraversal%2FArticles%2FHARYANA%2FROHTAK71.php;src=sdkpreparse">Share</a></div>
...
function Load(){ 
	var g='i='+71+'&id='+2; $.ajax({type:"POST",url:"../../../points/trend.php",data:g,dataType:"json",cache:false,success:function(n){ 
	if(n.a!=null){
...
function fShare() { 
var obj = {method: "feed", link: "http://www.daanvir.org/Traversal/Articles/HARYANA/ROHTAK71.php", picture: "http://daanvir.org/main/Traversal/images/26/Hangouts_Penguins_006.png",name: "Daanvir - Angels",description: "Ajhsjsksod preety jo teri mujhdr jufi wo kisi or sr nhi jodna
Nhi jodn a
Jodna jond
A jznsobagsjabof
Dmf
