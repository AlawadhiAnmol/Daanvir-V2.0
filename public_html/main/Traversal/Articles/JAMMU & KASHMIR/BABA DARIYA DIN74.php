...
<gcse:search></gcse:search>
		...
		<div id="hitlist_image_cover">
			  <img src="../../../Traversal/images/26/IMG-20180424-WA0002.jpg" alt="Loading Image.." id="hitlist_image" class="image1"/> 
		</div>
    ...
    border-color: #4267b2;" id="hitlist_id">
		...
		<div id="hitlist_image_cover">
			  <img  src="../../../Traversal/images/26/FB_IMG_1524510771305.jpg" alt="Loading Image.." id="hitlist_image"  class="image2"/> 
		</div> 
		<div id="hitlist_expand1">
    ...
    border-color: #4267b2;"> 
		...
		<div class="fb-comments" style="margin:auto" data-adapt-container-width="true" data-href="http://daanvir.org/main/Traversal/Articles/JAMMU & KASHMIR/BABA DARIYA DIN74.php" data-width="100%" data-numposts="5" data-colorscheme="dark"></div>
		</div> 
	</div>
</div>
...
> Uncheck: Block third-party cookies and site data. </div>
	...
	<article id="hitlist_side"> 
		...
		<li id="H_LI_19">Test test test Test test test Test test test- (0% filled)
			</li>
		</ul>
    ...
    border-color: #4267b2;">Share Now!</a>
		...
		<div style="visibility:hidden;opacity:0;height:2px;overflow:hidden" class="fb-share-button" data-href="http://daanvir.org/main/Traversal/Articles/JAMMU & KASHMIR/BABA DARIYA DIN74.php" data-layout="button_count" data-size="large" data-mobile-iframe="true"><a class="fb-xfbml-parse-ignore" target="_blank" id="fbshare" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fdaanvir.org%2Fmain%2FTraversal%2FArticles%2FJAMMU & KASHMIR%2FBABA DARIYA DIN74.php;src=sdkpreparse">Share</a></div>
...
function Load(){ 
	var g='i='+74+'&id='+2; $.ajax({type:"POST",url:"../../../points/trend.php",data:g,dataType:"json",cache:false,success:function(n){ 
	if(n.a!=null){
...
function fShare() { 
var obj = {method: "feed", link: "http://www.daanvir.org/Traversal/Articles/JAMMU & KASHMIR/BABA DARIYA DIN74.php", picture: "http://daanvir.org/main/Traversal/images/26/IMG-20180424-WA0002.jpg",name: "Daanvir - Test test test Test test t",description: "Test test test Test test test Test test test Test test test Test test test Test test test Test test test Test test test Test test test. "};
