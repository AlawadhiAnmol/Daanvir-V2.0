<!DOCTYPE html>
<html> 
<head><title>Daanvir - The brave steps that lead the nation</title><meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1,user-scalable=no"><link rel="stylesheet" href="../../../normalize.css"><script src='../../../js/jquery.min.js'></script><link rel="shortcut icon" href="../../../images/favicon.png" type="image/x-icon"><link rel="stylesheet" href="../../../css/orton.css"><meta property="og:url"           content="http://daanvir.org/main/Traversal/Articles/JAMMU & KASHMIR/BABA DARIYA DIN60.php" />
	<meta property="og:type"          content="website" />
	<meta property="og:title"         content="Daanvir | Help them to fight cold Hazratbal Dargah" />
	<meta property="og:description"   content="We are local people trying to help children and old aged people." />
	<meta property="og:image"         content="http://daanvir.org/../../../Traversal/images/26/dying of cold2.jpg" />
</head>
<body>
<div id="fb-root"></div>
<script>
...
<gcse:search></gcse:search>
		...
		<div id="hitlist_image_cover">
			  <img src="../../../Traversal/images/26/dying of cold2.jpg" alt="Loading Image.." id="hitlist_image" class="image1"/> 
		</div>
		<header id="hitlist_header">
			<div id="hitlist_id">
				 <a href="" id="hitlist_id_a">JAMMU & KASHMIR - SRINAGAR - BABA DARIYA DIN</a>
			</div> 
			<div id="hitlist_id">
				 <a href="" id="hitlist_id_a" class="hit_location">Hazratbal Dargah</a>
			</div> 
    ...
    border-color: #4267b2;" id="hitlist_id">
			...
			<h2 id="H2_10" class="hit_tag">
				Help them to fight cold
			</h2>
		</header>
		<div id="hitlist_expand1">
			<p id="hitlist_expand_p" class="hit_head">
				We are local people trying to help children and old aged people.
			</p>
		</div>
		...
		<div id="hitlist_expand1">
			<p id="hitlist_expand_p" class="ext-des">
				COLD WEATHER IS EVIL
			</p>
		</div>
		<div id="hitlist_image_cover">
			  <img  src="../../../Traversal/images/26/dying of cold3.jpg" alt="Loading Image.." id="hitlist_image"  class="image2"/> 
		</div> 
		<div id="hitlist_expand1">
			<div id="hitlist_expand_p">
				old weather is 20 times as deadly as hot weather
			</div>
			<div id="hitlist_expand_p">
				- Started By Anmol Alawadhi
			</div>
		</div>
		<header id="hitlist_header">
    ...
    border-color: #4267b2;"> 
		...
		<div class="fb-comments" style="margin:auto" data-adapt-container-width="true" data-href="http://daanvir.org/main/Traversal/Articles/JAMMU & KASHMIR/BABA DARIYA DIN60.php" data-width="100%" data-numposts="5" data-colorscheme="dark"></div>
		</div> 
	</div>
</div>
...
> Uncheck: Block third-party cookies and site data. </div>
	...
	<article id="hitlist_side"> 
		...
		<li id="H_LI_19">As we all know that Srinagar is one of the coldest places in  India. Children and old people are deprived of warmth. They sleep without any blankets 
please donate more and more blankets to help these people fight cold.
Thankyou- (0% filled)
			</li>
		</ul>
		...
		<li id="H_LI_20">There were no supporters yet.</li>
		</ul>
    ...
    border-color: #4267b2;">Share Now!</a>
		...
		<div style="visibility:hidden;opacity:0;height:2px;overflow:hidden" class="fb-share-button" data-href="http://daanvir.org/main/Traversal/Articles/JAMMU & KASHMIR/BABA DARIYA DIN60.php" data-layout="button_count" data-size="large" data-mobile-iframe="true"><a class="fb-xfbml-parse-ignore" target="_blank" id="fbshare" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fdaanvir.org%2Fmain%2FTraversal%2FArticles%2FJAMMU & KASHMIR%2FBABA DARIYA DIN60.php;src=sdkpreparse">Share</a></div>
...
function Load(){ 
	var g='i='+60+'&id='+2; $.ajax({type:"POST",url:"../../../points/trend.php",data:g,dataType:"json",cache:false,success:function(n){ 
	if(n.a!=null){
...
function fShare() { 
var obj = {method: "feed", link: "http://www.daanvir.org/Traversal/Articles/JAMMU & KASHMIR/BABA DARIYA DIN60.php", picture: "http://daanvir.org/main/Traversal/images/26/dying of cold2.jpg",name: "Daanvir - Help them to fight cold",description: "We are local people trying to help children and old aged people.. COLD WEATHER IS EVIL"};
