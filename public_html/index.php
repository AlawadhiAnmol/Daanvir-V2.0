...
<noscript>
    <script> getElementId("slider").onmousehover=stop;</script>
    <style type="text/css">
...
<header class="cd-header nav-down" style="box-shadow:1px 1px 1px #4874f0,inset 0 0 1px #4874f0;
  ...
  <!--<a  id="heart-main" style="float:left;padding-left:40px;">Made with <strong id="heart"></strong> in India</a> -->    <span id="asdd_post"><b><span class="blink_me">&#9679;</span></b><a onclick="open_page(30);" style="font-weight:bold;">Add a Donation Post</a></span> |  <!--<b id="feeding_india"><i></i></b><a href="http://www.feedingindia.org">Feeding India</a> | --><a href="http://www.daanvir.org/faq.php" style="font-weight:bold;">FAQs</a> 
  </div>
    ...
    <nav class="cd-main-nav">
					<ul style="margin-top:20px;padding-left:20px">
						...
						<li ><a href=".donation-posts" style="font-family:'Josefin Sans' ;font-weight:700;">Donation Posts</a></li>
						<?php if(loggedIn()===false){ ?>
						<li><a href="#part-4" style="font-family:'Josefin Sans'; font-weight:700;">About</a></li>
						<li><a href="#part-8" style="font-family:'Josefin Sans'; font-weight:700;">Impact</a></li>
						<!--<li><a href="#part-5">Contact</a></li>-->
						<!--<li><a href="#page" onclick="bring(1)" id="bring"class="bringme">Login</a></li>--> 
						<?php }else{ ?> 
						<li><a href="#part-8" style="font-family:'Josefin Sans';
                            font-weight:700;">Impact</a></li>
						<li><a href="#part-8" style="font-family:'Josefin Sans'; font-weight:700;">Campaign</a></li>
						<!--<li><a href="#part-9">Relief</a></li>-->  
						<!--<li><a href="javascript:" onclick="logout();" class="logout" id="bring">Logout</a></li> -->
						<?php } ?> 
						<li><a href="javascript:void(0)" id="account_shw" style="font-family:'Josefin Sans'; font-weight:700;">Account</a>
						 <ul id="dropdown"> 
						<?php if(loggedIn()===false){ ?>
							<li id="drop1">
...
<style>
	...
	#main_slide div:nth-child(3) {
		background-image: url(../images/4.jpg);
         ...
         #main_slide > div { font-size: 100px }
         }
         @media screen and (max-width: 600px) { 
         #main_slide > div { font-size: 50px }
         }
         #main_slide > div {
         width: 100%;
         height: 100%;
         ...
         animation: imageAnimation 30s linear infinite 0s;
            ...
            <div class="contained_text">
                <b><font size="42"><b id="seperate1">Change</b></b><br></font>
                   <b id="seperate2">begins here </b><br>
                <font size="40"><b id ="seperate3"  style="color:grey"> Transparently </b></font>
            </div> 
				...
				<div class="opts">
                    <span><a href="javascript" onclick="open_page(30);" id="add" style="font-weight:bold;">Add a donation post</a></span>
                    <span><a href="#part-2" id="contri" style="font-weight:bold;">Contribute to existing donation posts</a></span>
                </div>
            ...
            <div id="slider3" class="slider w3-animate-right">
                <p id="seperate3">Education is their right. Help them get Education</p>
                <br>
                <!--<div id="para">
...
function carousel() {
    ...
    setTimeout(carousel, 12000);  
     ...
     $('#main_slide').click(function(){ if(aclick==0) aclick=1; else { aclick=0; carousel();}}); 

 $('#main_slide').mouseenter(function(){ aclick=1; }); 

 /*$('#main_slide').mouseleave(function(){ aclick=0; carousel();});*/
...
<script>
	...
	var lastScrollTop=0;
	var delta=5;
	var navbarHeight=$('.cd-header2').outerHeight();
	var cd=$('.cd-header2');
	console.log(cd);
	$(window.document).scroll(function(event){didScroll=!0});
	...
	var i=0;
	function movement(){
		var doc=document.getElementById("caption1");
		if(doc===null||typeof(doc)=='undefined')
			return;
		i++;
		if($('#rot1').isInViewport()&&i%10==0){
			$('#rot1').animateRotate(360,600);
			$('#rot2').animateRotate(360,1000);
			$('#rot3').animateRotate(360,1200);
			i=0
		}
		return
	}
	...
	$.fn.animateRotate=function(angle,duration,easing,complete){
		return this.each(function(){
			var $elem=$(this);
			$({deg:0}).animate({deg:angle},{duration:duration,easing:easing,step:function(now){$elem.css({transform:'rotatex('+now+'deg)'})},complete:complete||$.noop})})};
...
<div class="section norma">
    <div class="working">
        <div id="work_header" style="text-align:center;font-size:25px;font-family:'Quicksand', sans-serif;">
            <p >Daanvir.org is a strong movement<br> to mobilize people to help the needy directly.</p>
        </div>
        <hr style="width:100%;height:10px;border:none;background-color:#f2f2f2;margin-left:-15px;">
        <font style="font-size:40px;position:relative;top:70px;left:30px;color:#595959"><p id="seperate2">How <br>it works </p></font><br><font style="font-size:120px;position:relative;top:-28px;width:10px;left:200px;color:#d6d6d6"> &#10093;</font>
        <div class="container_1"><p id="seperate2">
            Responsible citizens report issues and create campaigns </p>
        </div>
        <div class="container_2">
            <p id="seperate2">
                People nearby reach out to help those in need. </p>
        </div>
...
return}
	...
	<div id="wrap-boxes-hitlist" >
        <div id="people_support" style="overflow:auto;">
            <div id="people_header" style="width:100%">
                People Supporting
            </div>
<!--            <marquee direction="up";  behavior="scroll"; scrolldelay=1;>-->
            <div id="people_activity">
                    <img id="people_picture" src="img1/funsa.png" style="width:50px;height:50px;float:left;"/>
                <div id="people_part">
                    <span id="people_name">Anmol Founsa</span> contributed on the campaign Cloths for clothless - Raffle contest.
                </div>
                <div id="people_time">
                    4 hours ago
                </div>
            ...
            <div id="people_activity">
                    <img id="people_picture" src="img1/lovish.png" style="width:50px;height:50px;float:left;"/>
                <div id="people_part">
                    <span id="people_name">Lovish singh chib</span> contributed on the campaign Drawing books for oprhanages - Raffle contest.
                </div>
                <div id="people_time">
                    6 hours ago
                </div>
            ...
            <div id="people_activity">
                    <img id="people_picture" src="img1/nitish.png" style="width:50px;height:50px;float:left;"/>
                <div id="people_part">
                    <span id="people_name">Nitish Malpotra</span> contributed on the campaign Drawing books for orphanges - Raffle contest.
                </div>
                <div id="people_time">
                    6 hours ago
                </div>
            ...
            <div id="people_activity">
                    <img id="people_picture" src="img1/aayush.jpg" style="width:50px;height:50px;float:left;"/>
                <div id="people_part">
                    <span id="people_name">Aayush Aggarwal</span> contributed on the campaign Kusht Aashram - Raffle contest.
                </div>
                <div id="people_time">
                    10 hours ago
                </div>
            ...
            <div id="people_activity">
                    <img id="people_picture" src="img1/Akshadha.jpg" style="width:50px;height:50px;float:left;"/>
                <div id="people_part">
                    <span id="people_name">Akshadha Khamkar</span> contributed on the campaign Kusht aashram Raffle contest.
                </div>
                <div id="people_time">
                    9 hours ago
                </div>
            ...
            <div id="people_activity">
                    <img id="people_picture" src="img1/Aman chib.jpg" style="width:50px;height:50px;float:left;"/>
                <div id="people_part">
                    <span id="people_name">Aman Chib</span> contributed on the campaign Cloths for clothless - Raffle contest.
                </div>
                <div id="people_time">
                    9 hours ago
                </div>
            ...
            <div id="people_activity">
                    <img id="people_picture" src="img1/anagha.jpg" style="width:50px;height:50px;float:left;"/>
                <div id="people_part">
                    <span id="people_name">Anagha Sethuraman</span> contributed on the campaign Cloths for clothless - Raffle contest.
                </div>
                <div id="people_time">
                    4 hours ago
                </div>
            ...
            <div id="people_activity">
                    <img id="people_picture" src="img1/Gaurangi.jpg" style="width:50px;height:50px;float:left;"/>
                <div id="people_part">
                    <span id="people_name">Gaurangi Chaudhary</span> contributed on the campaign Cloths for clothless - Raffle contest.
                </div>
                <div id="people_time">
                    4 hours ago
                </div>
            ...
            <div id="people_activity">
                    <img id="people_picture" src="img1/Gyan Prakash.jpg" style="width:50px;height:50px;float:left;"/>
                <div id="people_part">
                    <span id="people_name">Gyan Prakash</span> contributed on the campaign Cloths for clothless - Raffle contest.
                </div>
                <div id="people_time">
                    4 hours ago
                </div>
            ...
            <div id="people_activity">
                    <img id="people_picture" src="img1/Jaspal.jpg" style="width:50px;height:50px;float:left;"/>
                <div id="people_part">
                    <span id="people_name">Jaspal Brar</span> contributed on the campaign Cloths for clothless - Raffle contest.
                </div>
                <div id="people_time">
                    4 hours ago
                </div>
            ...
            <div id="people_activity">
                    <img id="people_picture" src="img1/Kafeel.jpg" style="width:50px;height:50px;float:left;"/>
                <div id="people_part">
                    <span id="people_name">Kafeel Rabani</span> contributed on the campaign Cloths for clothless - Raffle contest.
                </div>
                <div id="people_time">
                    4 hours ago
                </div>
            ...
            <div id="people_activity">
                    <img id="people_picture" src="img1/Krishna.jpg" style="width:50px;height:50px;float:left;"/>
                <div id="people_part">
                    <span id="people_name">Krishna Aggarwal</span> contributed on the campaign Cloths for clothless - Raffle contest.
                </div>
                <div id="people_time">
                    4 hours ago
                </div>
            ...
            <div id="people_activity">
                    <img id="people_picture" src="img1/Lalit.jpg" style="width:50px;height:50px;float:left;"/>
                <div id="people_part">
                    <span id="people_name">Lalit Naagar</span> contributed on the campaign Cloths for clothless - Raffle contest.
                </div>
                <div id="people_time">
                    4 hours ago
                </div>
            ...
            <div id="people_activity">
                    <img id="people_picture" src="img1/Langar.jpg" style="width:50px;height:50px;float:left;"/>
                <div id="people_part">
                    <span id="people_name">Sarvesh Langar</span> contributed on the campaign Kashmir Killing winter.
                </div>
                <div id="people_time">
                    4 hours ago
                </div>
            ...
            <div id="people_activity">
                    <img id="people_picture" src="img1/rishabh.jpg" style="width:50px;height:50px;float:left;"/>
                <div id="people_part">
                    <span id="people_name">Rishabh Joshi</span> contributed on the campaign Food for orphanages.
                </div>
                <div id="people_time">
                    4 hours ago
                </div>
...
<div id="thoughts-container" class="part">
	...
	<div id="thoughts-wrap">
		...
		<div class="owl-carousel  owl-theme" >
			...
			<div id="thought-box"><div id="thought-author"><img class="flip" src="images/Ankit kawatra.jpg" alt="?"></div><div id="thought-details"><p id="details-author">Ankit Kawatra<br><span> - Founder, Feeding India</span></p><blockquote><p> Some people think luxury is the opposite of poverty. It is not. It is the opposite of vulgarity.</p></blockquote></div></div>

			<div id="thought-box"><div id="thought-author"><img class="flip" src="images/Prakash .png" alt="?"></div><div id="thought-details"><p id="details-author">Gyan Prakash <br><span> - Director, MAIT  </span></p><blockquote><p> Some people think luxury is the opposite of poverty. It is not. It is the opposite of vulgarity </p></blockquote></div></div>

			<div id="thought-box"><div id="thought-author"><img class="flip" src="images/Ritu Rathee.png" alt="?"></div><div id="thought-details"><p id="details-author"> Ritu Rathee<br><span> - Vlogger and Entrepreneur, Indian Beauty Vlogger </span></p><blockquote><p> Some people think luxury is the opposite of poverty. It is not. It is the opposite of vulgarity.</p></blockquote></div></div>

			<div id="thought-box"><div id="thought-author"><img class="flip" src="images/Sakshi Dhiman.png" alt="?"></div><div id="thought-details"><p id="details-author">Sakshi Dhiman<br><span> - Best Selling Author, Semicolon(;) </span></p><blockquote><p>Some people think luxury is the opposite of poverty. It is not. It is the opposite of vulgarity</p></blockquote></div></div>

			<div id="thought-box"><div id="thought-author"><img class="flip" src="images/Srishti jain.png" alt="?"></div><div id="thought-details"><p id="details-author">Srishti Jain<br><span>- Co-Founder, Feeding India </span></p><blockquote><p> Some people think luxury is the opposite of poverty. It is not. It is the opposite of vulgarity.</p></blockquote></div></div>

			<div id="thought-box"><div id="thought-author"><img class="flip" src="images/Upasna.png" alt="?"></div><div id="thought-details"><p id="details-author">Upasna Dhingra<br><span> - Entrepreneur, SSB Education </span></p><blockquote><p> Some people think luxury is the opposite of poverty. It is not. It is the opposite of vulgarity </p></blockquote></div></div>
            
            <div id="thought-box"><div id="thought-author"><img class="flip" src="images/Sradha.png" alt="?"></div><div id="thought-details"><p id="details-author">Sradha Ingewar<br><span> - Model </span></p><blockquote><p> Some people think luxury is the opposite of poverty. It is not. It is the opposite of vulgarity </p></blockquote></div></div>
            
            <div id="thought-box"><div id="thought-author"><img class="flip" src="images/Upasna.png" alt="?"></div><div id="thought-details"><p id="details-author">Nelson Mandela<br><span> - Former President </span></p><blockquote><p> Some people think luxury is the opposite of poverty. It is not. It is the opposite of vulgarity </p></blockquote></div></div>
...
<div class="section norma">
	...
	<div id="part-8" class="slideUp" style="height:auto;">
		...
		<header id="don_cover" class="cd-header5 collapseh1 part">
            <div style="color:#fff;position:absolute;left:5%;top:10%;font-size:25px;font-family:segoe ui; font-weight:600;">If you see something,
            </div>
            <div style="color:#fff;position:absolute;left:5%;top:18.5%;font-size:25px;font-family:segoe ui; font-weight:600;">
            #don't keep quiet.
            </div>
            <div style="color:yellow;position:absolute;left:5%;top:35%;font-size:30px;font-weight:600;">
                Report it here
            </div>
            <a href="javascript" onclick="open_page(30);"><button id="c_campaign" style="border:none;background-color:#2874f0;padding:10px;color:#fff;font-size:27px;position:absolute;left:5%;top:48%;font-family:FuturaFuturis;font-weight:600;  ">Create a Campaign</button></a>
            <br>
            <div style="color:#fff;position:absolute;left:5%;top:65%;font-size:25px;font-family:FuturaFuturis;font-weight:600">and get the country to join you</div>
	</header> <br><br>
	<div class="help_p">
        <img src="images/idea.png"/><font style="color:#2874f0;position:relative;top:10%;right:2%;font-size:30px;float:right;font-weight:900"><b>Ideas on what to start your campaign on </b></font>
	</div>
        <div id="help_box" style="font-family:Raleway">
            <p>Help needy people to get access to food, clothing and basic essectials. </p>
        </div>
        <div id="help_box2" style="font-family:Raleway">
            Help donate supplies for disaster hit victims.
        </div>
        <div id="help_box3" style="font-family:Raleway">
            Clean up a dirty area around your house, school, college or office
        </div>
        <div id="help_box4" style="font-family:Raleway">
...
<script>
	...
	$.ajax({
		...
		data:{"id":1, "limit":5, "offset":0},
		type:"POST",
		success: function(result) {
			$(".mywatermark").html(result);bindOwl();
		}
	});
	});
</script>
...
<div class="section">
	...
	<header class="cd-header5 expandh1 part"> 
		...
		<p class="help_p">Our aim is to help thousands of people in need across the country through 20 Daanvirs in every Indian state by December 2018.
...
<span style="text-align:center;font-family:esl_gothic; color:grey;"><h4>&copy; 2017 - All Rights Reserved | <a  id="heart-main" >Made with <strong id="heart"></strong> in India</a></h4></span>
...
<script language="javascript">function open_page(num){document.getElementById("opened-content").innerHTML="<h2 id=\"loading\">Loading...</h2>";
if(num!=7) {
  if($('#opened-page').css('display','none'))
    $('#opened-page').css('display','block');
  $('#opened-page').css('left','0');
  $('#opened-page').css('transitionDuration','0.5s');
  $('#opened-page').css({'-webkit-animation':'bounceIn 2s linear 0s','-moz-animation':'bounceIn 2s linear 0s','-o-animation':'bounceIn 2s linear 0s','-ms-animation':'bounceIn 2s linear 0s','animation':'bounceIn 2s linear 0s'})
} else {
  $('#opened-page').css('left','0');
  $('#opened-page').css('transitionDuration','0.5s');
  if(!$('#opened-page').css('display','none'))
...
var g="num="+num;$.ajax({type:"POST",url:"main/html/open.php",data:g,
success:function(n){if(num!=7) {
  $('#opened-content').load(n);
