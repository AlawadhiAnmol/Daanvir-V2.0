	...
	<div id="wrap-boxes-hitlist" >
        <div id="people_support">
            ...
            <div id="people_activity">
                ...
                <div id="people_part">
                    <span id="people_name">Aman Kumar</span> contributed on the campaign Cloths for clothless - Raffle contest.
                </div>
                <div id="people_time">
                    4 hours ago
                </div>
            ...
            <div id="people_activity">
                    <img id="people_picture" src="img/user-man-circle-invert-512.png" style="width:50px;height:50px;float:left;"/>
                <div id="people_part">
                    <span id="people_name">Sushma Kumari</span> contributed on the campaign Kashmir Killing winter.
                </div>
                <div id="people_time">
                    4 hours ago
                </div>
            ...
            <div id="people_activity">
                    <img id="people_picture" src="img/user-man-circle-invert-512.png" style="width:50px;height:50px;float:left;"/>
                <div id="people_part">
                    <span id="people_name">Rahul Trivedi</span> contributed on the campaign Food for orphanages.
                </div>
                <div id="people_time">
                    4 hours ago
                </div>
...
<div id="thoughts-container" class="part">
	...
	<div id="thoughts-wrap">
		...
		<div class="owl-carousel  owl-theme" >
			...
			<div id="thought-box"><div id="thought-author"><img class="flip" src="images/Bill-Gates.png" alt="?"></div><div id="thought-details"><p id="details-author">Bill Gates <br><span> - Business magnate and philanthropist</span></p><blockquote><p> Some people think luxury is the opposite of poverty. It is not. It is the opposite of vulgarity </p></blockquote></div></div>

			<div id="thought-box"><div id="thought-author"><img class="flip" src="images/Edmund-Burke.png" alt="?"></div><div id="thought-details"><p id="details-author"> Edmund Burke<br><span> - Author and philosopher</span></p><blockquote><p> Some people think luxury is the opposite of poverty. It is not. It is the opposite of vulgarity.</p></blockquote></div></div>
...
<div class="section norma">
	...
	<div id="part-8" class="slideUp" style="height:auto;">
		...
		<header id="don_cover" class="cd-header5 collapseh1 part">
            ...
            <a href="javascript" onclick="open_page(30);"><button id="c_campaign" style="border:none;background-color:#2874f0;padding:10px;color:#fff;font-size:27px;position:absolute;left:5%;top:60%;font-family:FuturaFuturis;font-weight:600;  ">Create a Campaign</button></a>
            <br>
            <div style="color:#fff;position:absolute;left:5%;top:75%;font-size:25px;font-family:FuturaFuturis;font-weight:600">and get the country to join you</div>
	</header> <br><br>
	<div class="help_p">
