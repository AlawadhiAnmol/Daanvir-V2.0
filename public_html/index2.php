...
<style>
    ...
    <div class="mySlides w3-animate-fading"  style="width:100%;height: 400px;">
    ...
    <div class="mySlides w3-animate-fading" style="width:100%;height: 400px;background:#000;color:#fff;">
    ...
    <div class="mySlides w3-animate-fading"  style="width:100%;height:400px;background:url('secondary.png')">
        <div id="secondary">
        <p>Education is their right. Help them get Education</p><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
        ...
        <style>
            ...
            .w3-badge,.w3-tag{background-color:#000;color:#000;display:inline-block;padding-left:8px;padding-right:8px;text-align:center}
            .w3-badge{border-radius:50%}
            .w3-border{border:1px solid #ccc!important}
            .w3-transparent,.w3-hover-none:hover{background-color:transparent!important}
            .w3-hover-white:hover{color:#000!important;background-color:#000!important}
        </style>
    ...
    <span class="w3-badge demo w3-border w3-transparent w3-hover-white" onclick="currentDiv(3)"></span></div>
</div>
