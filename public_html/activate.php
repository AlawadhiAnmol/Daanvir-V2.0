...
//isLoggedIn();
?>
<head><title>Daanvir: Activate Account</title>
        <meta charset="UTF-8" />
...
<div id="FORM_3" class="settings-form">
			<h1 id="H1_4" style="font-size:24px">
				Activate Your Daanvir Account
			</h1>
			<div id="errors10"></div> 
<p id="P_5">
				 
				<label for="emailreg1" id="LABEL_6">
					Username or email
				</label>
				<input id="INPUT_7" class="emailreg1"  placeholder="myusername123 or myemail@mail.com" />
			</p> 
				<input type="button" class="regsubmit111" value="SEND CODE" id="INPUT_15" /><br>
	...
	<p id="P_5">
				...
				<input type="button" class="regsubmit112" value="VERIFY" id="INPUT_15" /><input type="hidden" name="token__" class="token__" value="<?php
			echo $token;
			?>" />
				</div>
	</div>		
</div><script language="javascript">
$(".regsubmit111").click(function(){ 
if(document.getElementById("hide").style.display!="none")
document.getElementById("hide").style.display="none"; 
var a=$(".emailreg1").val();	  	
var h=$(".token__").val();
var g="a="+a+"&d="+1+"&h="+h;
$.ajax({type:"POST",url:"main/php/verifyme.php",data:g,success:function(n){  
if(n==1){
document.getElementsByClassName("emailreg1")[0].readOnly = true;
document.getElementById("errors10").innerHTML="A verification code was sent to your mail.";
setTimeout(function(){ 
if(document.getElementById("hide").style.display="none")
document.getElementById("hide").style.display="block";
},1500);
}else{	 
document.getElementById("errors10").innerHTML="Error: Invalid Input Submitted";
}
},error:function(n){  
document.getElementById("errors10").innerHTML="Unexpected Error.";
}}) 
});
$(".regsubmit112").click(function(){ 
var c=$(".userregcode").val();	 
var e=$(".emailreg1").val();	  	
var h=$(".token__").val();
var g="c="+c+"&d="+2+"&e="+e+"&h="+h;
$.ajax({type:"POST",url:"main/php/verifyme.php",data:g,success:function(n){
if(n==1){
document.getElementById("errors10").innerHTML="Successfully Verified! Please Log In now.";
$(".userregcode").val('');	 
$(".emailreg1").val('');
setTimeout(function(){ 
document.getElementById("hide").style.display!="none";
...
document.getElementById("errors10").innerHTML="Something went wrong.";
}
}}) 
});
</script>
